...
public class oAuthTest {
	...
	public static void main(String[] args) {
		...
		/*
		 * String response2 = given().queryParams("access_token",
		...
		/*
		 * GetCourse gc = given().queryParams("access_token",
		 * accessToken).when().log().all()
		 * .get("https://rahulshettyacademy.com/oauthapi/getCourseDetails").as(GetCourse
		 * .class);
		 * 
